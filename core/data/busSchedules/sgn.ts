...
export const BUS_152: BusRoute = {
  ...
  //
  // SGN-T2 (international): Làn B, đối diện cột 12 và cột 13 sảnh đến quốc tế.
  //   Exit the international arrival hall, walk straight across Làn A (private-vehicle lane) into Làn B.
