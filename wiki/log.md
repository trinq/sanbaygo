...
- 2026-08-02 — Migration to Cloudflare Pages complete. New ADR-0004 supersedes ADR-0003 (VPS). Live at https://www.frylane.com/. Sources touched: `docs/adr/0004-cloudflare-pages.md` (new), `wiki/pages/decisions.md` (ADR index + migration log), `wiki/pages/tooling.md` (deployment section rewritten). Deleted: `.github/workflows/deploy.yml`, `scripts/deploy.sh`, `docs/vps-deployment-guide.md`. Outcome: deployment is now zero-ops via CF Pages GitHub integration; latency from Vietnam <10ms via CF edge; no recurring cost.
