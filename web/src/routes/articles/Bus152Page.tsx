...
export function Bus152Page() {
  const config: BusArticleConfig = {
    seoPath: '/bus-152-saigon-fare',
    h1En: 'Bus 152 — Tan Son Nhat Airport T1/T2 to Ben Thanh',
    categoryLabel: 'Xe buýt sân bay TP.HCM',
    subtitle: `VND ${BUS_152.ticketPrice.toLocaleString()} · ${BUS_152.operatingHours.start}–${BUS_152.operatingHours.end} · Every 12–20 min`,
    bus: BUS_152,
    airportCode: 'SGN',
  ...
  return (
    <>
      ...
      <nav className="max-w-3xl mx-auto px-4 pb-8 text-sm text-ink-soft">
        ...
        {' · '}
        <a href="/bus-152-saigon-fare" className="text-primary underline">Bus 152 — Saigon fare guide</a>
        {' · '}
